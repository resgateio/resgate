	...
	encodings := []struct {
	...
	}{
		{
			...
			map[string]string{
				...
				"test.model.softparent":   `{"name":"parent","child":{"href":"/api/test/model/soft","model":{"name":"soft","child":{"href":"/api/test/model"}}}}`,
				...
				"test.collection.soft.parent":  `["parent",{"href":"/api/test/collection","collection":["soft",{"href":"/api/test/collection"}]}]`,
		...
		},
		{
			...
			map[string]string{
				...
				"test.collection.soft":         `["soft",{"href":"/api/test/collection"}]`,
				"test.collection.soft.parent":  `["softparent",{"name":"soft","child":{"href":"/api/test/collection"}}]`,
				"test.c.a":                     `[{"href":"/api/test/c/a"}]`,
